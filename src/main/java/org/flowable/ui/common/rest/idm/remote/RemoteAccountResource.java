...
public class RemoteAccountResource {
    ...
    public UserRepresentation getAccount() {
        ...
        //add by huxipi
        ((RemoteIdmServiceImpl)remoteIdmService).setUrl(((RemoteIdmServiceImpl) remoteIdmService).getUrl().replace("flowable-idm",applicationContext.getApplicationName().substring(1)));
